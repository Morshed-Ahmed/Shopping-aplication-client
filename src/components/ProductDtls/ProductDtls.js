            ...
            <Grid container spacing={2}>
                ...
                <Grid item md={4} sm={12}>
                    ...
                    <div>
                        ...
                        <Box style={{display:'flex',justifyContent:'center',fontSize:'20px',}}>
                        <Box sx={{padding:'5px',margin:'5px'}}>-</Box>
                        <Box sx={{padding:'5px',margin:'5px'}}>0</Box>
                        <Box sx={{padding:'5px',margin:'5px'}}>+</Box>
                        </Box>
                         <Box>
                         <button style={{ padding: '10px', borderRadius: '5px', margin: '10px' }}>Add to cart</button>
                         </Box>
                        </Box>
                    </div>
                </Grid>
